...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 19, 2015 at 05:43 PM
...
(1, 'Ramone', 'Dobson', 'curly', 'dabo'),
(3, 'Neelam', 'Samtani', 'iphones', 'indie'),
(4, 'Odaine', 'Forbes', 'cameras', 'oforbes'),
(48, 'David', 'Baine', 'alteroo', 'dbaine'),
(51, '', '', '', ''),
(52, '', '', '', ''),
(53, '', '', '', ''),
(54, '', '', '', '');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='Column information for phpMyAdmin' AUTO_INCREMENT=16 ;
...
(6, 'c9', 'User', 'id', '', '', '_', ''),
(7, 'c9', 'User', 'firstname', '', '', '_', ''),
(8, 'c9', 'User', 'lastname', '', '', '_', ''),
(9, 'c9', 'User', 'password', '', '', '_', ''),
(10, 'c9', 'User', 'username', '', '', '_', ''),
(11, 'c9', 'Message', 'id', '', '', '_', ''),
(12, 'c9', 'Message', 'body', '', '', '_', ''),
(13, 'c9', 'Message', 'subject', '', '', '_', ''),
(14, 'c9', 'Message', 'user_id', '', '', '_', ''),
(15, 'c9', 'Message', 'recipient_ids', '', '', '_', '');
...
('oforbes_', '[{"db":"c9","table":"User"},{"db":"c9","table":"Message"},{"db":"c9","table":"Message_read"}]');
